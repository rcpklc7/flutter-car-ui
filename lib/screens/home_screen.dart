import 'package:car/screens/components/light.dart';
import 'package:flutter/material.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter_svg/svg.dart';
import 'package:car/constanins.dart';
import 'package:car/home_controller.dart';
import 'package:car/model/TyrePsi.dart';
                ...
                builder: (context, constrains) {
                  return Stack(
                    ...
                    children: [
                      ...
                      Visibility(
                        visible: !_controller.isLight,
                        child: Positioned(
                          top: -10,
                          left: -15,
                          height: constrains.maxWidth/1.5,
                      ...
                      AnimatedPositioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          child: Light(
                            isLight: _controller.isLight,
                            press: _controller.updateLight,
                          ),
                        ),
                      ),
                      AnimatedPositioned(
